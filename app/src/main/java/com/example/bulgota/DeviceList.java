...
public class DeviceList extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int listId = getIntent().getIntExtra("layout_list", R.layout.bluetooth_list);
        ...
        scanButton = (Button) findViewById(R.id.btn_search);
        String strScanDevice = getIntent().getStringExtra("검색");
        ...
        int layout_text = getIntent().getIntExtra("layout_text", R.layout.bluetooth_name);
